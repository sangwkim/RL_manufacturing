...
class OrnsteinUhlenbeckProcess(Continuous):
    ...
    def _sample(self, n, initial=1, zero=True, decay=1.):
        ...
        for k in range(n):
            ...
            s.append(initial)
            self.vol = self.vol * decay

        return np.array(s)

    def sample(self, n, initial=1, zero=True, decay=1.):
        ...
        """
        return self._sample(n, initial, zero, decay)
